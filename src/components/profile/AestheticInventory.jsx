...
export default function AestheticInventory() {
  return (
    <div className="lg:col-span-4 bg-zinc-950 border border-[#c28e3a]/10 rounded-3xl p-5 sm:p-8 pt-8 sm:pt-10 shadow-[inset_0_0_30px_rgba(194,142,58,0.05),0_10px_30px_rgba(0,0,0,0.8)] relative overflow-hidden flex flex-col justify-between group">
      ...
      <div className="mt-4">
        ...
        <div className="grid grid-cols-4 gap-2 mb-6">
          {['mdi:activity', 'mdi:swords', 'mdi:flame', 'mdi:gem'].map((icon, idx) => (
            <div key={idx} className="aspect-square rounded-full border border-[#c28e3a]/20 bg-zinc-900/50 flex items-center justify-center text-[#c28e3a]/80 hover:border-[#c28e3a] hover:text-white transition-all shadow-[0_0_10px_rgba(194,142,58,0.1)] hover:shadow-[0_0_15px_rgba(194,142,58,0.3)]">
        ...
        <div className="flex items-center justify-center gap-3 my-4">
          <div className="h-[1px] bg-[#c28e3a]/20 flex-1"></div>
          <span className="text-[10px] text-[#c28e3a]/60 font-black tracking-widest">❖</span>
          <div className="h-[1px] bg-[#c28e3a]/20 flex-1"></div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            ...
            { icon: 'game-icons:crystal-wand', color: '#c28e3a', name: 'AETHER' },
            { icon: 'game-icons:dragon-shield', color: '#c28e3a', name: 'LEGION' }
          ].map((item, idx) => (
            <div key={idx} className="bg-black/50 border border-[#c28e3a]/10 p-3 rounded-xl flex flex-col items-center justify-center text-center hover:border-[#c28e3a]/30 transition-all group">
        ...
        <div className="grid grid-cols-4 gap-2">
          {[
            { icon: 'game-icons:crown', color: '#c28e3a' },
            { icon: 'game-icons:elixir', color: '#e8b96a' },
            { icon: 'game-icons:dinosaur-bones', color: '#a1752b' },
            { icon: 'game-icons:crystal-growth', color: '#f5dfa0' }
          ].map((item, idx) => (
            <div key={idx} className="aspect-square rounded-xl bg-zinc-900/50 border border-[#c28e3a]/15 flex items-center justify-center hover:border-[#c28e3a] transition-all">
