...
export default function QuizHome() {
  ...
  return (
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-8 relative overflow-hidden font-monda text-white">
      ...
      >
        <iconify-icon icon="mdi:settings" width="16"></iconify-icon>
        Paramètres
      </button>
      ...
      <div className="relative z-10 w-full max-w-4xl text-center space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16 max-w-3xl mx-auto">
          ...
          >
            ...
            <iconify-icon icon="mdi:play" width="60" className="text-[#c28e3a] group-hover:text-black mb-4 transition-colors"></iconify-icon>
          ...
          >
            <iconify-icon icon="mdi:users" width="60" className="text-white mb-4"></iconify-icon>
          ...
          >
            <iconify-icon icon="mdi:library" width="50" className="text-[#c28e3a] mb-4"></iconify-icon>
          ...
          >
            <iconify-icon icon="mdi:gamepad2" width="50" className="text-[#c28e3a] mb-4"></iconify-icon>
