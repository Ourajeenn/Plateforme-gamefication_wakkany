...
import AestheticInventory from './profile/AestheticInventory';
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mt-10">
        <HabitTracker playScanSFX={playScanSFX} />
        <AestheticInventory />
      </div>
      ...
      {/* Badge Gallery */}
      <div className="mt-8">
        <BadgeGallery unlockedAchievements={unlockedAchievements} xp={xp} />
      </div>
