...
export const BOSS_LEVELS = [
  { id: 1, name: "La Faille de l'Aube",       color: '#6366f1', colorDark: '#1e1b4b', icon: 'mdi:weather-sunset' },
  { id: 2, name: "Le Sanctuaire des Ombres",   color: '#ec4899', colorDark: '#500724', icon: 'mdi:moon-waning-crescent' },
  { id: 3, name: "Le Trône du Néant",          color: '#f1f5f9', colorDark: '#0f0f1a', icon: 'mdi:infinity' },
];
...
export const BOSS_ENCOUNTERS = [
  ...
  },
  {
    ...
    icon: 'mdi:diamond-stone', color: '#10b981',
  ...
  },
  {
    ...
    icon: 'mdi:sparkles', color: '#a855f7',
  ...
  },
  {
    ...
    icon: 'mdi:infinity', color: '#ffffff',
